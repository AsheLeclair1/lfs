<h1 class="pageTitle text-center">Сообщить о найденной вещи</h1>
<hr class="mx-auto bg-primary border-primary opacity-100" style="width:50px">
<div class="row justify-content-center">
    <div class="col-lg-8 col-md-8 col-sm-12 col-12">
        <div class="card">
            <div class="card-body py-4">
                <h4 class="pageTitle">Пожалуйста, заполните все обязательные поля</h4>
                <form action="" id="item-form">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="fullname" class="control-label">ФИО нашедшего</label>
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="text" name="location_found" id="location_found" class="form-control form-control-sm rounded-0" value="<?php echo isset($location_found) ? $location_found : ''; ?>" placeholder="Например: Торговый центр, Парк, Школа..." />
                            <small class="text-muted">Укажите место, где был найден предмет</small>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <label for="contact" class="control-label">Контактный телефон</label>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="" class="control-label">Изображение предмета</label>
            ...
            <div class="card-footer">
                <div class="col-lg-4 col-md-6 col-sm-10 col-12 mx-auto">
                    <button class="btn btn-primary btn-sm w-100" form="item-form"><i class="bi bi-send"></i> Отправить</button>
                </div>
            </div>
        </div>
    </div>
